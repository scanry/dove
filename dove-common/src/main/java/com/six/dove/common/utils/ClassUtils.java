...
public class ClassUtils {
	...
	public static String[] parmaTypes(Method method) {
		String[] parmaTypes =null;
		if(null!=method) {
			Class<?>[] parameterTypes = method.getParameterTypes();
			parmaTypes = new String[parameterTypes.length];
			for (int i = 0; i < parameterTypes.length; i++) {
				Class<?> parameterType = parameterTypes[i];
				parmaTypes[i] = parameterType.getCanonicalName();
			}
		}
		return parmaTypes;
	}
