...
public interface ClientRemote
	 ...
	 * @return
	 */
	<T> T getOrNewRemoteProtocolProxy(String callHost, int callPort, Class<?> clz);
	 ...
	 * @return
	 */
	<T> T getOrNewRemoteProtocolProxy(String callHost, int callPort, Class<?> clz, AsyCallback callback);
	 ...
	 * @return
	 */
	String generateProtocolProxyClassCode(Class<?> protocol, String packageName, String className);
}
