...
public interface DoveClient extends Service {
	 ...
	 * @return
	 */
	<T> T lookupService(Class<?> clz, String version);
	 ...
	 * @return
	 */
	<T> T lookupService(Class<?> clz, String version, AsyCallback callback);
	 ...
	 * @return
	 */
	<T> T lookupService(String targetHost, int targetPort, Class<?> clz, String version);
	 ...
	 * @return
	 */
	<T> T lookupService(String targetHost, int targetPort, Class<?> clz, String version, AsyCallback callback);
